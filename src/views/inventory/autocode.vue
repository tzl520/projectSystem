...
<script>
  import {getList, getDetail, add, update, remove} from "@/api/inventory/autocode";
          ...
          column: [
            {
              label: "编码类型",
              prop: "type",
              dicUrl: '/api/blade-system/dict-biz/dictionary?code=type',
              props: {
                label: "dictValue",
                value: "dictKey"
              },
            ...
            },
            {
              label: "日期格式",
              prop: "dateFormart",
              dicUrl: '/api/blade-system/dict-biz/dictionary?code=dateFormart',
              props: {
                label: "dictValue",
                value: "dictKey"
              },
