  ...
  <basic-container>
    <avue-crud :option="option"
      ...
      <template slot-scope="{type,size,row}" slot="menu">
        <el-button icon="el-icon-check" :size="size" :type="type" @click="againP(row)">重新派发</el-button>
      </template>
    </avue-crud>
    <el-dialog
    ...
    <el-button type="primary" @click="distributionAgain">确 定</el-button>
  </span>
    </el-dialog>
  </basic-container>
</template>
...
import {getList, add, update, remove, getDetail} from "@/api/workorder/refuse";
import {submitAgain} from "@/api/workorder/backe";
